...
class LevelTenActivity : AppCompatActivity() {
    ...
    private fun initializeCards() {
        val imageResources = listOf(
            ...
            R.drawable.card_zip_reverse, R.drawable.card_chicken,
            R.drawable.card_mushroom, R.drawable.card_fox,
            R.drawable.card_sparkle, R.drawable.card_rail,
            R.drawable.card_sword, R.drawable.card_carrot,
            R.drawable.card_gem, R.drawable.card_apple,
            R.drawable.card_melon,
        )
    ...
    private fun restartGame() {
        finish()
        startActivity(Intent(this, LevelTenActivity::class.java))
    }
