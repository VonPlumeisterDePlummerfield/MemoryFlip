...
class LevelFiveActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        ViewCompat.setOnApplyWindowInsetsListener(findViewById(R.id.main_level_five)) { v, insets ->
    ...
    private fun restartGame() {
        finish()
        startActivity(Intent(this, LevelSixActivity::class.java))
    }
